...
public class VacancyController {
    ...
    @GetMapping("/search")
    ResponseEntity<VacancyResponse> findByTitle(@RequestParam @NotBlank String title) {
        var response = vacancyMapper.mapToResponse(vacancyService.findByTitle(title));
